...
- (void)setupLabel {
    ...
    _attributesHandle = @{NSForegroundColorAttributeName: C1, NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:14.0]};
    ...
    _attributesHashtag = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:34/255.f green:34/255.f blue:34/255.f alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:14.0]};
...
- (void)determineHotWords {
    ...
    [validCharactersSet addCharactersInString:@"？"];
    [validCharactersSet addCharactersInString:@"."];
    [validCharactersSet addCharactersInString:@"。"]; // added by tong
...
- (void)setText:(NSString *)text {
    [super setText:@""];
    _textView.textContainer.maximumNumberOfLines = _number;
    _cleanText = text;
